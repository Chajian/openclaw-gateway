...
import { info, warn, error } from "@openclaw/core";
...
async function runPowershell(scriptName, extraArgs = []) {
...
export function activate(ctx) {
  ...
  ctx.commands.register("task:install", {
    ...
    run: async (argv) => {
      const stableTime = config.stableCycleTime || "09:10";
      const linuxdoTime = config.linuxdoCycleTime || "08:40";
